            ...
            <div className="relative w-full pt-16 pb-24 overflow-hidden">
                <div className="max-w-7xl mx-auto p-5 flex flex-col gap-8">
                    ...
                    <div className="grid md:grid-cols-4 lg:grid-cols-6 gap-4">
                        <div className="bg-white border border-gray-200 rounded-xl shadow p-7 flex flex-col gap-6 col-span-2">
                            <div className="w-12 h-12 bg-gray-200 rounded-xl flex items-center justify-center">
                        ...
                        <div className="bg-white border border-gray-200 rounded-xl shadow p-7 flex flex-col gap-6 md:col-span-4 lg:col-span-2">
                            <div className="w-12 h-12 bg-gray-200 rounded-xl flex items-center justify-center">
